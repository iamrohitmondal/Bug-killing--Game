...
function opacity() {
    return new Promise((resolve) => {
        ...
        Object.assign(document.getElementById("choose-level").style, {
            transition: "opacity 1s linear 0s",
            opacity: "0",
...
document.getElementById("startbutton").addEventListener("click", () => {
    ...
    document.getElementById("imageofbigspider").style.display = "none";
